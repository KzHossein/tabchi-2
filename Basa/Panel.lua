...
local token = '473225316:AAEX-fKkC-F_5WSfg7UfB7po9WIq_lyqw6M' --token
local url = 'https://api.telegram.org/bot' .. token
local offset = 0
local redis = require('redis')
local redis = redis.connect('127.0.0.1', 6379)
local botcli = 388838617
local SUDO = 435014771
local BOT = 1
local BOT2 = 2
local BOT3 = 3
...
--------Close-------#Bibak
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                   {text = '• BANGER TEAM', url = 'https://t.me/banger_team'}
				}
							}
